...
const LeavePage = () => {
  ...
  const handleWithdraw = async(e) => {
    //
    const withdraw_url = "http://127.0.0.1:5000/" + role + "/" + user_id + "/leave_applications/" + leave_id + "/withdraw"
    fetch(withdraw_url).then((data) => data.json())
    .then((data)=> {}, [])
  ...
  const url = "http://127.0.0.1:5000/" + role + "/" + user_id + "/leave_applications/" + leave_id
      ...
      <div className="singleContainer">
        ...
        <div className="bottom">
          <div className="left">
            ...
            {
              (isWithdrawButton && isApplicant) && <button style={{"background-color":"blue"}} className="del" onClick={handleWithdraw}>WITHDRAW</button>
            }
            {
              (isCancelButton && isApplicant) && <button style={{"background-color":"orange"}} className="del" onClick={handleCancel}>CANCEL</button>
            }
            </div>
          </div>
        </div>
