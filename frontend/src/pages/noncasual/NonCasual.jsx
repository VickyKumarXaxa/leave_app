...
const NonCasual = () => {
    ...
    const url = "http://127.0.0.1:5000/" + role + "/" + user_id + "/leave category/noncasual"
                ...
                <div className="bottomContent">
                    <form onSubmit={handleSubmit}>
                        <div className="formContainer">
                            <label>User ID</label>
                            <input type="text" placeholder={2} readOnly/>
                        </div>
                        <div className="formContainer">
                            <label>Nature of Leave applied for</label>
                            <input 
                                type="text" 
                                value={nature_of_leave} 
                                placeholder="Nature of leave" 
                                onChange={(e) => setnature_of_leave(e.target.value)} 
                                required
                            />
                        </div>
                        <div className="formContainer">
                        ...
                        <div className="formContainer">
                            ...
                            <input type="text"  
                                ...
                                placeholder="Alternative arrangements"
